...
<head>
    <base href="" />
    <title>Skeleton - Admin Template</title>
    <meta charset="utf-8" />
    ...
    <link href="{{ asset('assets/css/custom-data-table.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/custom-theme.css') }}" rel="stylesheet" type="text/css" />

    <!--end::Global Stylesheets Bundle-->
    @php
        $currentRoute = \Illuminate\Support\Facades\Route::currentRouteName();
        $cssResources = \App\Helpers\ResourceLoader::loadCss($currentRoute);
        $jsResources = \App\Helpers\ResourceLoader::loadJs($currentRoute);
    @endphp

    {{-- Chargement des ressources CSS --}}
    @foreach ($cssResources as $css)
...
<body id="kt_app_body" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true"
    ...
    {{-- Chargement des ressources JS --}}
    @foreach ($jsResources as $js)
