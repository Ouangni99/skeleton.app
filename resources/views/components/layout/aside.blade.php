        ...
        <div id="kt_app_sidebar_nav_wrapper" class="d-flex flex-column px-8 px-lg-10 hover-scroll-y"
            ...
            <div class="mb-0">
                ...
                <div class="row g-5" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                    ...
                    <div class="col-6">
                        <!--begin::Link-->
                        <a href="../../demo37/dist/apps/calendar.html"
                    ...
                    <div class="col-6">
                        <!--begin::Link-->
                        <a href="../../demo37/dist/apps/support-center/licenses.html"
                            class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-100px h-100px border-gray-200"
                            data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                    ...
                    <div class="col-6">
                        <!--begin::Link-->
                        <a href="../../demo37/dist/apps/support-center/overview.html"
                            class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-100px h-100px border-gray-200"
                            data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                    ...
                    <div class="col-6">
                        <!--begin::Link-->
                        <a href="../../demo37/dist/apps/file-manager/folders.html"
                            class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-100px h-100px border-gray-200"
                            data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                    ...
                    <div class="col-6">
                        <!--begin::Link-->
                        <a href="../../demo37/dist/apps/file-manager/settings.html"
